...
import { OnerousAssessmentUpsert, OnerousAssessmentQuery } from "@aibos/contracts";
...
export const GET = withRouteErrors(async (request: NextRequest) => { try {
        ...
        const assessments = await onerousAssessor.queryAssessments(auth.company_id, validatedQuery);
