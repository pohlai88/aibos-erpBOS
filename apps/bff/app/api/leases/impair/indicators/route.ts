...
import { ImpairmentIndicatorUpsert, ImpairmentIndicatorQuery } from "@aibos/contracts";
...
export const GET = withRouteErrors(async (request: NextRequest) => { try {
        ...
        const indicators = await indicatorService.queryIndicators(auth.company_id, validatedQuery);
