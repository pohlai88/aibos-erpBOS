...
export async function POST(request: NextRequest) {
    try {
        ...
        const result = await disclosureService.generateDisclosureSnapshot(auth.company_id, data);
...
export async function GET(request: NextRequest) {
    try {
        ...
        const result = await disclosureService.generateDisclosures(auth.company_id, data);
