    ...
    try {
        ...
        const result = {
            ...
            test_completeness: {
                ...
                completeness_percentage: testPlanCountResult.rows[0].total_plans > 0
                    ? Math.round((testResultCountResult.rows[0].total_results / testPlanCountResult.rows[0].total_plans) * 100)
                    : 0
            },
            pass_rate: {
            ...
            deficiency_summary: {
                total_deficiencies: parseInt(deficiencyCountResult.rows[0].total_deficiencies),
                open_deficiencies: parseInt(deficiencyCountResult.rows[0].total_deficiencies),
