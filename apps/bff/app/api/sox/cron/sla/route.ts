...
export const POST = withRouteErrors(async (request: NextRequest) => {
  ...
  try {
    ...
    logLine({
      level: 'info',
      msg: `SOX SLA check completed for company ${authCtx.company_id}: ${result.overdue_deficiencies} overdue, ${result.approaching_due} approaching, ${result.aging_deficiencies} aging`,
    });
