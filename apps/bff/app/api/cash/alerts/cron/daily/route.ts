...
export const GET = withRouteErrors(async (req: Request) => {
    try {
        ...
        console.log(`🚀 Starting enterprise cash alerts cron job at ${new Date().toISOString()}`);
        ...
        return badRequest("Enterprise cash alerts cron failed: " + (error instanceof Error ? error.message : 'Unknown error'));
    }
});
...
export const POST = withRouteErrors(async (req: Request) => {
    try {
        ...
        console.log(`🚀 Manual cash alerts processing triggered with custom options:`, body);
