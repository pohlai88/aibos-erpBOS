...
export const POST = withRouteErrors(async (request: NextRequest) => {
  try {
    ...
    const result = await playbookStudio.createApprovalRequest(
      companyId,
      userId,
      data
    );
...
export const PUT = withRouteErrors(async (request: NextRequest) => {
  try {
    ...
    const result = await playbookStudio.processApprovalDecision(
      companyId,
      userId,
      data
    );
...
export const GET = withRouteErrors(async (request: NextRequest) => {
  try {
    ...
    const result = await playbookStudio.getApprovalRequests(
      companyId,
      queryParams
    );
