...
export const POST = withRouteErrors(async (request: NextRequest, { params }: { params: { id: string } }) => {
    ...
    const result = await service.requestDownloadKey(companyId, auditorId, validatedData.grant_id, validatedData.object_id);
