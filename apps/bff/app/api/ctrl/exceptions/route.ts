...
export const GET = withRouteErrors(async (request: NextRequest) => {
    ...
    const query = ExceptionQuery.parse({
        ...
        remediation_state: searchParams.get("remediation_state") as any || undefined,
        material: searchParams.get("material") === "true" ? true : searchParams.get("material") === "false" ? false : undefined,
        assignee: searchParams.get("assignee") || undefined,
        sla_breach: searchParams.get("sla_breach") === "true" ? true : searchParams.get("sla_breach") === "false" ? false : undefined,
