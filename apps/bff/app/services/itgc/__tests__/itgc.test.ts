...
describe("ITGC & UAR Bridge Services", () => {
    ...
    describe("ITGCBreakglassService", () => {
        it("should manage break-glass access", async () => {
            ...
            const updatedActiveBreakglass = await breakglassService.getActiveBreakglass(testCompanyId);
    ...
    describe("ITGCEvidenceService", () => {
        it("should take snapshots of ITGC data", async () => {
            ...
            // Take a snapshot
            const snapshot = await evidenceService.takeSnapshot(testCompanyId, testUserId, {
                scope: "USERS"
            });
        ...
        it("should build UAR evidence packs", async () => {
            ...
            // Build evidence pack
            const pack = await evidenceService.buildUARPack(testCompanyId, testUserId, {
    ...
    describe("ITGCIngestService", () => {
        it("should run data ingestion", async () => {
            ...
            // Run ingestion
            const result = await ingestService.runIngestion(testCompanyId, testUserId, {
                system_id: testSystemId,
                force: false
            });
