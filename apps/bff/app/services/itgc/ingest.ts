...
export class ITGCIngestService {
    ...
    private async runConnector(
        ...
        try {
            ...
            await this.emitConnectorEvent(companyId, userId, connector.id, 'completed', {
                processed,
     ...
     */
    private async runSCIMConnector(companyId: string, connector: any): Promise<number> {
        ...
        console.log(`SCIM connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
     ...
     */
    private async runSAMLConnector(companyId: string, connector: any): Promise<number> {
        // TODO: Implement SAML connector
        console.log(`SAML connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
     ...
     */
    private async runOIDCConnector(companyId: string, connector: any): Promise<number> {
        // TODO: Implement OIDC connector
        console.log(`OIDC connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
     ...
     */
    private async runSQLConnector(companyId: string, connector: any): Promise<number> {
        ...
        console.log(`SQL connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
     ...
     */
    private async runCSVConnector(companyId: string, connector: any): Promise<number> {
        ...
        console.log(`CSV connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
     ...
     */
    private async runAPIConnector(companyId: string, connector: any): Promise<number> {
        ...
        console.log(`API connector for system ${connector.system_id} - placeholder implementation`);
        return 0;
    }
    ...
    private async upsertEntitlements(
        ...
        for (const entitlementData of entitlements) {
            ...
            await this.dbInstance
                ...
                .onConflictDoUpdate({
                    target: [itEntitlement.companyId, itEntitlement.systemId, itEntitlement.kind, itEntitlement.code],
                    set: {
    ...
    private async upsertGrants(
        ...
        for (const grantData of grants) {
            ...
            await this.dbInstance
                ...
                .values(grantRecord)
                .onConflictDoUpdate({
                    target: [itGrant.companyId, itGrant.systemId, itGrant.userId, itGrant.entitlementId],
                    set: {
     ...
     */
    private async getConnectorsForSystem(companyId: string, systemId: string): Promise<any[]> {
     ...
     */
    private async emitIngestEvent(companyId: string, userId: string, data: any): Promise<void> {
