...
export async function getAmortizationSchedule(companyId: string, planId: string) {
...
export async function getUnbookedAmortizationSchedules(companyId: string, year: number, month: number) {
    const result = await pool.query(
