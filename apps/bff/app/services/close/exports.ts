...
import { closeItem, closeSlaPolicy } from '@aibos/db-adapter/schema';
import type {
  HeatMapResponseType,
...
export class CloseExportsService {
   ...
   */
  async exportCsv(companyId: string, query: any): Promise<string> {
