...
describe("MdnaService", () => {
    ...
    describe("updateDraft", () => {
        it("should update an existing draft", async () => {
            ...
            const updatedDraft = await service.updateDraft(companyId, draft.id, userId, updateData);
    ...
    describe("publishMdna", () => {
        it("should publish an approved draft", async () => {
            ...
            const published = await service.publishMdna(companyId, userId, publishData);
