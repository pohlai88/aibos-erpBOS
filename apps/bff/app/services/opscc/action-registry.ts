...
export class ActionRegistry {
  ...
  getInverseAction(
    code: string,
    stepOutput: any
  ): ActionDescriptorM27_2 | undefined {
    const action = this.getAction(code);
    if (!action?.inverse) {
      return undefined;
    }
  ...
  private async executeAllocAction(
    code: string,
    input: any,
    context: any
  ): Promise<any> {
  ...
  private async executeRevenueAction(
    code: string,
    input: any,
    context: any
  ): Promise<any> {
  ...
  private async executeInsightsAction(
    code: string,
    input: any,
    context: any
  ): Promise<any> {
  ...
  private async executeCashAction(
    code: string,
    input: any,
    context: any
  ): Promise<any> {
  ...
  private registerDefaultActions(): void {
    ...
    this.registerAction({
      ...
      inverse: {
        ...
        deriveInput: (output: any) => ({
          payment_ids: output.dispatched_payments,
        }),
      },
    });
