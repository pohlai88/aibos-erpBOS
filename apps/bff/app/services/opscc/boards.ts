...
export class BoardsService {
     ...
     */
    async getBoardConfig(companyId: string, board: BoardType): Promise<BoardConfigResponse | null> {
        try {
    ...
    async upsertBoardConfig(
        ...
        try {
            ...
            logLine({
                ...
                companyId, config, error: error instanceof Error ? error.message : String(error)
            });
            throw error;
        }
    }
     ...
     */
    async getTileConfigs(companyId: string, board: BoardType): Promise<TileConfigResponse[]> {
        try {
            const results = await this.dbInstance
                .select()
                .from(kpiTileConfig)
    ...
    async updateTileOrder(
        ...
        try {
            ...
            logLine({
                ...
                companyId, board, tileOrders, error: error instanceof Error ? error.message : String(error)
            });
            throw error;
        }
    }
    ...
    async deleteTileConfig(
        ...
        try {
            ...
            logLine({
                ...
                companyId, board, tileId, error: error instanceof Error ? error.message : String(error)
            });
            throw error;
        }
    }
