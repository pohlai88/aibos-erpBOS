        ...
        try {
            ...
            const insertResult = await client.query(
                `INSERT INTO sox_deficiency 
                 ...
                 RETURNING id`,
                [
                    companyId, data.control_id, data.discovered_in, data.type, data.severity,
                    data.description, data.root_cause, data.aggregation_id, data.rem_owner_id,
                    data.remediation_plan, data.remediation_due, userId
                ]
            );
