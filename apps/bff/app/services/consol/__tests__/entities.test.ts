...
import { upsertEntity, upsertGroup, upsertOwnership, getOwnershipTree } from "../entities";
...
describe("Consolidation Entities", () => {
    ...
    it("should resolve ownership tree with effective dating", async () => {
        ...
        const midYearOwnership = await getOwnershipTree(companyId, "APAC-GRP", "2025-06-15");
        const endYearOwnership = await getOwnershipTree(companyId, "APAC-GRP", "2025-12-31");
