...
describe("Intercompany Tagging & Matching", () => {
    ...
    it("should create IC link with correct counterparty", async () => {
        ...
        expect(result.amountBase).toBe(1200.00);
    });
    ...
    it("should reject IC match when tolerance exceeded", async () => {
        ...
        const link2 = await createIcLink(companyId, {
            ...
            source_type: "AP",
            source_id: "INV-1001",
            amount_base: -1000.00 // Different amount
        });
        ...
        await expect(createIcMatch(companyId, matchData, actor))
            .rejects.toThrow("IC match tolerance exceeded");
    });
