...
export class RbBillingService {
    ...
    private async generateSubscriptionInvoice(
        ...
        return {
            ...
            fx_present_rate: inv.fxPresentRate ? Number(inv.fxPresentRate) : undefined,
    ...
    async getInvoiceLines(
        ...
        return lines.map(line => ({
            ...
            kind: line.kind as "ONE_TIME" | "RECURRING" | "USAGE" | "CREDIT" | "ADJUSTMENT" | "ROUNDING",
