...
export class JournalTemplateService {
  ...
  getFinanceSubleaseMonthlyTemplate(): JournalTemplate {
    return {
      ...
      description:
        'Monthly finance sublease posting (Dr NIS / Cr Interest Income)',
      lines: [
        {
          accountCode: 'NIS',
          drCr: 'DR',
  ...
  getOperatingSubleaseMonthlyTemplate(): JournalTemplate {
    return {
      ...
      description:
        'Monthly operating sublease posting (Dr Cash/A/R / Cr Lease Income)',
      lines: [
        {
          accountCode: 'CASH',
          drCr: 'DR',
  ...
  getSlbInitialTemplate(): JournalTemplate {
    return {
      ...
      description:
        'Initial SLB posting (Dr Cash, ROU / Cr Asset, Liability, Gains)',
      lines: [
        {
          accountCode: 'CASH',
          drCr: 'DR',
  ...
  getSlbMonthlyTemplate(): JournalTemplate {
    return {
      ...
      description:
        'Monthly SLB posting (interest, ROU amortization, deferred gain unwind)',
      lines: [
        {
