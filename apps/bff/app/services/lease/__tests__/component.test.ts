...
describe('ComponentDesignService', () => {
    ...
    describe('designFromAllocation', () => {
        it('should create components from valid allocation splits', async () => {
            ...
            const components = await service.getLeaseComponents(testCompanyId, testLeaseId);
        ...
        it('should throw error for invalid percentage sum', async () => {
            ...
            await expect(
                service.designFromAllocation(testCompanyId, testUserId, testLeaseId, splits)
        ...
        it('should throw error for useful life exceeding lease term', async () => {
            ...
            await expect(
                service.designFromAllocation(testCompanyId, testUserId, testLeaseId, splits)
            ).rejects.toThrow('useful life (48 months) exceeds lease term (36 months)');
        });
    ...
    describe('getLeaseComponents', () => {
        it('should return components for a lease', async () => {
            ...
            await service.designFromAllocation(testCompanyId, testUserId, testLeaseId, splits);
    ...
    describe('updateComponentAllocation', () => {
        it('should update component allocation', async () => {
            ...
            const updatedComponents = await service.getLeaseComponents(testCompanyId, testLeaseId);
...
describe('ComponentScheduleService', () => {
    ...
    describe('buildSchedules', () => {
        it('should build schedules for components', async () => {
            ...
            const result = await service.buildSchedules(testCompanyId, testUserId, testLeaseId);
            ...
            const schedules = await service.getComponentSchedule(testCompanyId, result.component_schedules[0]!.component_id);
    ...
    describe('getComponentSchedule', () => {
        it('should return component schedule for specific period', async () => {
            ...
            const schedules = await service.getComponentSchedule(testCompanyId, componentId, 2024, 1);
