...
export class ControlsAdminService {
     ...
     * Get control by ID
     */
    async getControl(companyId: string, controlId: string): Promise<ControlResponseType> {
     ...
     */
    async getAssignment(companyId: string, assignmentId: string): Promise<AssignmentResponseType> {
