...
import { RevPolicyService, RevRpoService, RevArtifactsService } from '../policy';
...
describe('M25.1 Revenue Recognition - Service Tests', () => {
    ...
    describe('Revenue Allocation Service', () => {
        ...
        it('should create POB manually', async () => {
            ...
            expect(result.allocated_amount).toBe(12000.00);
    ...
    describe('Revenue Schedule Service', () => {
        it('should build ratable monthly schedule', async () => {
            ...
            const pob = await allocationService.createPOB(testCompanyId, testUserId, pobData);
    ...
    describe('Revenue Recognition Service', () => {
        ...
        it('should query recognition runs', async () => {
            ...
            const result = await recognitionService.queryRecognitionRuns(testCompanyId, query);
    ...
    describe('Integration Tests', () => {
        it('should complete full revenue recognition workflow', async () => {
            ...
            // 3. Build schedule
            const scheduleResult = await scheduleService.buildSchedule(testCompanyId, testUserId, {
                pob_id: pob.id,
                method: 'RATABLE_MONTHLY',
                start_date: '2025-01-01',
                end_date: '2025-12-31'
            ...
            const recognitionResult = await recognitionService.runRecognition(testCompanyId, testUserId, {
                year: 2025,
                month: 1,
                dry_run: true
            });
            ...
            const rpoResult = await rpoService.createSnapshot(testCompanyId, testUserId, {
                as_of_date: '2025-01-31',
                currency: 'USD'
            });
            ...
            console.log('✅ Full revenue recognition workflow completed successfully');
        });
    });
});
