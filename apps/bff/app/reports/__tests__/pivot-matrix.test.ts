...
describe("buildPivotMatrix", () => {
    it("builds rows and totals with null label", () => {
        const lines = [
            { account_code: "6000", account_name: "COGS", cost_center: "CC-OPS", amount: 100 },
            { account_code: "6000", account_name: "COGS", cost_center: null, amount: 50 },
            { account_code: "6100", account_name: "Freight", cost_center: "CC-OPS", amount: 30 },
        ];
        const m = buildPivotMatrix(lines, (l) => `${l.account_code} ${l.account_name}`, {
    ...
    it("handles project pivot", () => {
        const lines = [
            { account_code: "6000", account_name: "COGS", project: "PRJ-ALPHA", amount: 100 },
            { account_code: "6000", account_name: "COGS", project: "PRJ-BETA", amount: 50 },
            { account_code: "6100", account_name: "Freight", project: "PRJ-ALPHA", amount: 30 },
        ];
        const m = buildPivotMatrix(lines, (l) => `${l.account_code} ${l.account_name}`, {
            pivotKey: "project",
            nullLabel: "Unassigned",
    ...
    it("handles precision correctly", () => {
        const lines = [
            { account_code: "6000", account_name: "COGS", cost_center: "CC-OPS", amount: 100.123456 },
        ];
        const m = buildPivotMatrix(lines, (l) => `${l.account_code} ${l.account_name}`, {
            pivotKey: "cost_center",
            nullLabel: "Unassigned",
