// M01 Core Ledger - WORKING Real Code Coverage Tests
// Focus: 100% v8 Code Coverage using ABSOLUTE PATHS
...
const apiPath = path.join(projectRoot, 'apps/bff/app/api/accounts/route');
const apiIdPath = path.join(projectRoot, 'apps/bff/app/api/accounts/[id]/route');
const apiHierarchyPath = path.join(projectRoot, 'apps/bff/app/api/accounts/hierarchy/route');
const componentFormPath = path.join(projectRoot, 'apps/web/components/core-ledger/AccountForm');
const componentListPath = path.join(projectRoot, 'apps/web/components/core-ledger/AccountList');
const componentHierarchyPath = path.join(projectRoot, 'apps/web/components/core-ledger/AccountHierarchy');
const hooksPath = path.join(projectRoot, 'apps/web/hooks/useAccounts');

describe('M01 WORKING Real Code Coverage Tests', () => {
