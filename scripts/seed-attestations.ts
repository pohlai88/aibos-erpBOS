...
import { attestProgram, attestTemplate, attestAssignment, appUser, company } from "@aibos/db-adapter/schema";
...
export async function seedAttestationsData() {
    ...
    try {
        ...
        const programData = {
            ...
            freq: "QUARTERLY",
            scope: ["PROCESS:R2R", "PROCESS:P2P", "PROCESS:O2C", "PROCESS:Treasury", "PROCESS:Tax"],
            active: true,
        ...
        const program404Data = {
            ...
            freq: "ANNUAL",
            scope: ["PROCESS:R2R", "PROCESS:P2P", "PROCESS:O2C", "PROCESS:Treasury", "PROCESS:Tax", "ENTITY:MY"],
            active: true,
            createdBy: adminUser.id,
            updatedBy: adminUser.id,
        };
        ...
        const template302Data = {
            ...
            schema: {
                ...
                questions: [
                    {
                        id: "q1",
                        label: "Have there been any material changes to internal controls over financial reporting?",
                        type: "YN",
                    ...
                    {
                        id: "q4",
                        label: "Describe any exceptions to standard policies and procedures:",
                        type: "TEXT",
                        requireEvidence: false,
                        required: false
                    },
        ...
        const template404Data = {
            ...
            schema: {
                ...
                questions: [
                    {
                        id: "q1",
                        label: "Management has evaluated the effectiveness of internal controls over financial reporting as of year-end:",
                        type: "YN",
                        requireEvidence: true,
                        required: true
                    },
                    {
                        id: "q2",
                        label: "Management has identified and documented all significant processes and controls:",
                        type: "YN",
                        requireEvidence: true,
                        required: true
                    },
                    {
                        id: "q3",
                        label: "Management has tested the operating effectiveness of key controls:",
                        type: "YN",
                        requireEvidence: true,
                        required: true
                    },
                    {
                        id: "q4",
                        label: "Management has remediated all material weaknesses identified:",
                        type: "YN",
                        requireEvidence: true,
                        required: true
                    },
                    {
                        id: "q5",
                        label: "Management has provided adequate disclosure of control deficiencies:",
                        type: "YN",
                        requireEvidence: true,
                        required: true
                    },
        ...
        console.log("🎉 M26.7 Attestations Portal seed data completed successfully!");
        console.log("");
