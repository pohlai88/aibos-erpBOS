import { pgTable, text, boolean, integer, numeric, timestamp, date, primaryKey } from "drizzle-orm/pg-core";
...
export const allocLock = pgTable("alloc_lock", {
    ...
    pk: primaryKey({ columns: [table.companyId, table.year, table.month, table.ruleId] })
}));
