...
export const closeItemComment = pgTable('close_item_comment', {
  ...
  itemId: uuid('item_id')
    .notNull()
    .references(() => closeItem.id, { onDelete: 'cascade' }),
...
export const closeItemCommentRelations = relations(
  closeItemComment,
  ({ one }) => ({
    item: one(closeItem, {
...
export const closeItemActionRelations = relations(
  closeItemAction,
  ({ one }) => ({
    item: one(closeItem, {
...
export const closeItemEvdLinkRelations = relations(
  closeItemEvdLink,
  ({ one }) => ({
    item: one(closeItem, {
