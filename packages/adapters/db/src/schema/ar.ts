...
export const arCashAppLink = pgTable('ar_cash_app_link', {
  id: text('id').primaryKey(),
  cashAppId: text('cash_app_id')
    .notNull()
    .references(() => arCashApp.id, { onDelete: 'cascade' }),
...
export const arCheckoutTxn = pgTable('ar_checkout_txn', {
  ...
  intentId: text('intent_id')
    .notNull()
    .references(() => arCheckoutIntent.id, { onDelete: 'cascade' }),
...
export const arStatementLine = pgTable('ar_statement_line', {
  ...
  runId: text('run_id')
    .notNull()
    .references(() => arStatementRun.id, { onDelete: 'cascade' }),
  companyId: text('company_id').notNull(),
  customerId: text('customer_id').notNull(),
