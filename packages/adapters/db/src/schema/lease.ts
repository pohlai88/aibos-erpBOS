...
export const lease = pgTable(
  ...
  table => ({
    companyCodeIdx: index('idx_lease_company_code').on(
      table.companyId,
      table.leaseCode
    ),
    companyClassStatusIdx: index('idx_lease_company_class_status').on(
      table.companyId,
      table.assetClass,
      table.status
    ),
    companyCommenceIdx: index('idx_lease_company_commence').on(
      table.companyId,
      table.commenceOn
    ),
  })
...
export const leaseCashflow = pgTable(
  'lease_cashflow',
  {
    id: text('id').primaryKey(),
  ...
  table => ({
    leaseDueIdx: index('idx_lease_cashflow_lease_due').on(
      table.leaseId,
      table.dueOn
    ),
  })
...
export const leaseSchedule = pgTable(
  'lease_schedule',
  {
    id: text('id').primaryKey(),
    leaseId: text('lease_id')
  ...
  table => ({
    uniqueLeasePeriod: unique('lease_schedule_unique').on(
      table.leaseId,
      table.year,
      table.month
    ),
    leasePeriodIdx: index('idx_lease_schedule_lease_period').on(
      table.leaseId,
      table.year,
      table.month
    ),
    companyPeriodIdx: index('idx_lease_schedule_company_period').on(
      table.leaseId,
      table.year,
      table.month
    ),
...
export const leaseEvent = pgTable(
  'lease_event',
  {
    id: text('id').primaryKey(),
    leaseId: text('lease_id')
  ...
  table => ({
    leaseEffectiveIdx: index('idx_lease_event_lease_effective').on(
      table.leaseId,
      table.effectiveOn
    ),
  })
...
export const leasePostLock = pgTable(
  'lease_post_lock',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    uniqueCompanyPeriod: unique('lease_post_lock_unique').on(
      table.companyId,
      table.year,
      table.month
    ),
    companyPeriodIdx: index('idx_lease_post_lock_company_period').on(
      table.companyId,
      table.year,
      table.month
    ),
...
export const leaseDisclosure = pgTable(
  'lease_disclosure',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    ...
    financeSubleaseInterest: numeric('finance_sublease_interest')
      .notNull()
      .default('0'), // finance sublease interest income
    ...
    slbDeferredGainCarry: numeric('slb_deferred_gain_carry')
      .notNull()
      .default('0'), // SLB deferred gain carryforward
    ...
    partialDerecognition: numeric('partial_derecognition')
      .notNull()
      .default('0'), // partial termination amounts
    ...
    restorationUtilization: numeric('restoration_utilization')
      .notNull()
      .default('0'), // restoration provision utilized
    createdAt: timestamp('created_at', { withTimezone: true })
      .notNull()
      .defaultNow(),
  },
  table => ({
    uniqueCompanyPeriod: unique('lease_disclosure_unique').on(
      table.companyId,
      table.year,
      table.month
    ),
    companyPeriodIdx: index('idx_lease_disclosure_company_period').on(
      table.companyId,
      table.year,
      table.month
    ),
    maturityJsonbIdx: index('idx_lease_disclosure_maturity_jsonb').using(
      'gin',
      table.maturityJsonb
    ),
    rollforwardJsonbIdx: index('idx_lease_disclosure_rollforward_jsonb').using(
      'gin',
      table.rollforwardJsonb
    ),
  })
);

export const leaseAttachment = pgTable(
  'lease_attachment',
  {
    id: text('id').primaryKey(),
    leaseId: text('lease_id')
  ...
  table => ({
    leaseTypeIdx: index('idx_lease_attachment_lease_type').on(
      table.leaseId,
...
export const leaseCpiIndex = pgTable(
  'lease_cpi_index',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    uniqueCompanyCodeDate: unique('lease_cpi_index_unique').on(
      table.companyId,
      table.indexCode,
      table.indexDate
    ),
    companyCodeDateIdx: index('idx_lease_cpi_index_company_code_date').on(
      table.companyId,
      table.indexCode,
      table.indexDate
    ),
    codeDateIdx: index('idx_lease_cpi_index_code_date').on(
      table.indexCode,
      table.indexDate
    ),
  })
...
export const leaseRemeasureArtifact = pgTable(
  'lease_remeasure_artifact',
  {
    ...
    eventId: text('event_id')
      .notNull()
      .references(() => leaseEvent.id, { onDelete: 'cascade' }),
  ...
  table => ({
    ...
    inputsJsonbIdx: index('idx_lease_remeasure_artifact_inputs_jsonb').using(
      'gin',
      table.inputsJsonb
    ),
    calculationsJsonbIdx: index(
      'idx_lease_remeasure_artifact_calculations_jsonb'
    ).using('gin', table.calculationsJsonb),
    outputsJsonbIdx: index('idx_lease_remeasure_artifact_outputs_jsonb').using(
      'gin',
      table.outputsJsonb
    ),
  })
...
export const leaseComponent = pgTable(
  'lease_component',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    uniqueLeaseCode: unique('lease_component_unique').on(
      table.leaseId,
      table.code
    ),
    companyLeaseIdx: index('idx_lease_component_company_lease').on(
      table.companyId,
      table.leaseId
    ),
    companyClassIdx: index('idx_lease_component_company_class').on(
      table.companyId,
      table.class
    ),
    leaseCodeIdx: index('idx_lease_component_lease_code').on(
      table.leaseId,
      table.code
    ),
  })
...
export const leaseComponentSched = pgTable(
  'lease_component_sched',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    leaseComponentId: text('lease_component_id')
      .notNull()
      .references(() => leaseComponent.id, { onDelete: 'cascade' }),
    year: integer('year').notNull(),
    month: integer('month').notNull(),
  ...
  table => ({
    uniqueCompanyComponentPeriod: unique('lease_component_sched_unique').on(
      table.companyId,
      table.leaseComponentId,
      table.year,
      table.month
    ),
    componentPeriodIdx: index('idx_lease_component_sched_component_period').on(
      table.leaseComponentId,
      table.year,
      table.month
    ),
    companyPeriodIdx: index('idx_lease_component_sched_company_period').on(
      table.companyId,
      table.year,
      table.month
    ),
...
export const leaseComponentLink = pgTable(
  'lease_component_link',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    leaseComponentId: text('lease_component_id')
  ...
  table => ({
    uniqueComponentTypeValue: unique('lease_component_link_unique').on(
      table.leaseComponentId,
      table.linkType,
      table.linkValue
    ),
    componentIdx: index('idx_lease_component_link_component').on(
      table.leaseComponentId
    ),
    companyTypeIdx: index('idx_lease_component_link_company_type').on(
      table.companyId,
      table.linkType
    ),
    valueIdx: index('idx_lease_component_link_value').on(
      table.linkType,
      table.linkValue
    ),
  })
...
export const leaseIndexProfile = pgTable(
  'lease_index_profile',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    uniqueLeaseIndex: unique('lease_index_profile_unique').on(
      table.leaseId,
      table.indexCode
    ),
    ...
    nextResetIdx: index('idx_lease_index_profile_next_reset').on(
      table.nextResetOn
    ),
    indexCodeIdx: index('idx_lease_index_profile_index_code').on(
      table.indexCode
    ),
  })
);

export const leaseMod = pgTable(
  'lease_mod',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
...
export const leaseModLine = pgTable(
  'lease_mod_line',
  {
    id: text('id').primaryKey(),
    modId: text('mod_id')
      .notNull()
      .references(() => leaseMod.id, { onDelete: 'cascade' }),
    leaseComponentId: text('lease_component_id').references(
      () => leaseComponent.id,
      { onDelete: 'cascade' }
    ), // null for lease-level changes
  ...
  table => ({
    ...
    componentIdx: index('idx_lease_mod_line_component').on(
      table.leaseComponentId
    ),
  })
);

export const leaseIndexValue = pgTable(
  'lease_index_value',
  {
    companyId: text('company_id').notNull(),
    indexCode: text('index_code').notNull(),
  ...
  table => ({
    pk: unique('lease_index_value_pk').on(
      table.companyId,
      table.indexCode,
      table.indexDate
    ),
    companyCodeIdx: index('idx_lease_index_value_company_code').on(
      table.companyId,
      table.indexCode
    ),
...
export const leaseRemeasurePost = pgTable(
  'lease_remeasure_post',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    leaseId: text('lease_id')
  ...
  table => ({
    uniqueCompanyLeaseModPeriod: unique('lease_remeasure_post_unique').on(
      table.companyId,
      table.leaseId,
      table.modId,
      table.year,
    ...
    periodIdx: index('idx_lease_remeasure_post_period').on(
      table.year,
      table.month
    ),
  })
...
export const leaseRemeasurePostLock = pgTable(
  'lease_remeasure_post_lock',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    uniqueCompanyLeaseModPeriod: unique('lease_remeasure_post_lock_unique').on(
      table.companyId,
      table.leaseId,
      table.modId,
      table.year,
...
export const leaseConcessionPolicy = pgTable(
  'lease_concession_policy',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    ...
    companyIdx: index('idx_lease_concession_policy_company').on(
      table.companyId
    ),
  })
);

export const leaseComponentSchedDelta = pgTable(
  'lease_component_sched_delta',
  {
    id: text('id').primaryKey(),
    leaseComponentId: text('lease_component_id')
      .notNull()
  ...
  table => ({
    uniqueComponentModPeriod: unique('lease_component_sched_delta_unique').on(
      table.leaseComponentId,
      table.modId,
      table.year,
      table.month
    ),
    componentIdx: index('idx_lease_sched_delta_component').on(
      table.leaseComponentId
    ),
    modIdx: index('idx_lease_sched_delta_mod').on(table.modId),
    periodIdx: index('idx_lease_sched_delta_period').on(
      table.year,
      table.month
    ),
    componentPeriodIdx: index('idx_lease_sched_delta_component_period').on(
      table.leaseComponentId,
      table.year,
      table.month
    ),
...
export const sublease = pgTable(
  'sublease',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    headLeaseId: text('head_lease_id')
      .notNull()
      .references(() => lease.id, { onDelete: 'cascade' }),
  ...
  table => ({
    ...
    classificationIdx: index('idx_sublease_classification').on(
...
export const subleaseCf = pgTable(
  'sublease_cf',
  {
    id: text('id').primaryKey(),
    subleaseId: text('sublease_id')
      .notNull()
      .references(() => sublease.id, { onDelete: 'cascade' }),
    dueOn: date('due_on').notNull(),
    amount: numeric('amount').notNull(),
  ...
  table => ({
    ...
    subleaseDueIdx: index('idx_sublease_cf_sublease_due').on(
      table.subleaseId,
      table.dueOn
    ),
  })
...
export const subleaseSchedule = pgTable(
  'sublease_schedule',
  {
    id: text('id').primaryKey(),
    subleaseId: text('sublease_id')
  ...
  table => ({
    uniqueSubleasePeriod: unique('sublease_schedule_unique').on(
      table.subleaseId,
      table.year,
      table.month
    ),
    subleaseIdx: index('idx_sublease_schedule_sublease').on(table.subleaseId),
    periodIdx: index('idx_sublease_schedule_period').on(
      table.year,
      table.month
    ),
    subleasePeriodIdx: index('idx_sublease_schedule_sublease_period').on(
      table.subleaseId,
      table.year,
      table.month
    ),
...
export const subleaseEvent = pgTable(
  'sublease_event',
  {
    id: text('id').primaryKey(),
    subleaseId: text('sublease_id')
  ...
  table => ({
    ...
    subleaseEffectiveIdx: index('idx_sublease_event_sublease_effective').on(
      table.subleaseId,
      table.effectiveOn
    ),
  })
...
export const subleasePostLock = pgTable(
  'sublease_post_lock',
  {
    id: text('id').primaryKey(),
    subleaseId: text('sublease_id')
  ...
  table => ({
    uniqueSubleasePeriod: unique('sublease_post_lock_unique').on(
      table.subleaseId,
      table.year,
      table.month
    ),
    subleaseIdx: index('idx_sublease_post_lock_sublease').on(table.subleaseId),
    periodIdx: index('idx_sublease_post_lock_period').on(
      table.year,
      table.month
    ),
  })
...
export const leaseComponentSublet = pgTable(
  'lease_component_sublet',
  {
    id: text('id').primaryKey(),
    leaseComponentId: text('lease_component_id')
      .notNull()
  ...
  table => ({
    uniqueComponentSublease: unique('lease_component_sublet_unique').on(
      table.leaseComponentId,
      table.subleaseId
    ),
    componentIdx: index('idx_lease_component_sublet_component').on(
      table.leaseComponentId
    ),
    subleaseIdx: index('idx_lease_component_sublet_sublease').on(
      table.subleaseId
    ),
    proportionIdx: index('idx_lease_component_sublet_proportion').on(
      table.proportion
    ),
  })
);

export const slbTxn = pgTable(
  'slb_txn',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    ...
    leasebackId: text('leaseback_id').references(() => lease.id, {
      onDelete: 'set null',
    }), // reference to leaseback lease
    evidencePackId: text('evidence_pack_id'), // reference to evidence pack
...
export const slbAllocation = pgTable(
  'slb_allocation',
  {
    id: text('id').primaryKey(),
    slbId: text('slb_id')
      .notNull()
      .references(() => slbTxn.id, { onDelete: 'cascade' }),
...
export const slbMeasure = pgTable(
  'slb_measure',
  {
    id: text('id').primaryKey(),
    slbId: text('slb_id')
...
export const leaseCgu = pgTable(
  ...
  table => ({
    companyCodeIdx: index('idx_lease_cgu_company_code').on(
      table.companyId,
      table.code
    ),
...
export const leaseCguLink = pgTable(
  'lease_cgu_link',
  {
    id: text('id').primaryKey(),
    leaseComponentId: text('lease_component_id')
    ...
    cguId: text('cgu_id')
      .notNull()
      .references(() => leaseCgu.id, { onDelete: 'cascade' }),
  ...
  table => ({
    componentIdx: index('idx_lease_cgu_link_component').on(
      table.leaseComponentId
    ),
    cguIdx: index('idx_lease_cgu_link_cgu').on(table.cguId),
    uniqueComponentCgu: unique('lease_cgu_link_unique').on(
      table.leaseComponentId,
      table.cguId
    ),
  })
...
export const leaseImpIndicator = pgTable(
  'lease_imp_indicator',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    asOfDate: date('as_of_date').notNull(),
    cguId: text('cgu_id').references(() => leaseCgu.id, {
      onDelete: 'cascade',
    }),
    leaseComponentId: text('lease_component_id').references(
      () => leaseComponent.id,
  ...
  table => ({
    ...
    componentIdx: index('idx_lease_imp_indicator_component').on(
      table.leaseComponentId
    ),
    companyDateIdx: index('idx_lease_imp_indicator_company_date').on(
      table.companyId,
      table.asOfDate
    ),
  })
...
export const leaseImpTest = pgTable(
  'lease_imp_test',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    dateCguIdx: index('idx_lease_imp_test_date_cgu').on(
      table.asOfDate,
      table.cguId
    ),
    statusIdx: index('idx_lease_imp_test_status').on(table.status),
    companyDateIdx: index('idx_lease_imp_test_company_date').on(
      table.companyId,
      table.asOfDate
    ),
  })
...
export const leaseImpLine = pgTable(
  'lease_imp_line',
  {
    id: text('id').primaryKey(),
    impairTestId: text('impair_test_id')
      .notNull()
      .references(() => leaseImpTest.id, { onDelete: 'cascade' }),
    leaseComponentId: text('lease_component_id')
      .notNull()
      .references(() => leaseComponent.id, { onDelete: 'cascade' }),
    carryingAmount: numeric('carrying_amount').notNull(),
  ...
  table => ({
    ...
    componentIdx: index('idx_lease_imp_line_component').on(
      table.leaseComponentId
    ),
  })
);

export const leaseImpPostLock = pgTable(
  'lease_imp_post_lock',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    ...
    uniqueTestPeriod: unique('lease_imp_post_lock_unique').on(
      table.impairTestId,
      table.year,
      table.month
    ),
...
export const leaseImpPost = pgTable(
  'lease_imp_post',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
  ...
  table => ({
    ...
    uniqueTestPeriod: unique('lease_imp_post_unique').on(
      table.impairTestId,
      table.year,
      table.month
    ),
...
export const leaseOnerousAssessment = pgTable(
  'lease_onerous_assessment',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    asOfDate: date('as_of_date').notNull(),
  ...
  table => ({
    ...
    componentIdx: index('idx_onerous_assessment_component').on(
      table.leaseComponentId
    ),
    statusIdx: index('idx_onerous_assessment_status').on(table.status),
    companyDateIdx: index('idx_onerous_assessment_company_date').on(
      table.companyId,
      table.asOfDate
    ),
  })
...
export const leaseOnerousRoll = pgTable(
  'lease_onerous_roll',
  {
    id: text('id').primaryKey(),
    assessmentId: text('assessment_id')
      .notNull()
      .references(() => leaseOnerousAssessment.id, { onDelete: 'cascade' }),
    year: integer('year').notNull(),
    month: integer('month').notNull(),
  ...
  table => ({
    ...
    uniqueAssessmentPeriod: unique('onerous_roll_unique').on(
      table.assessmentId,
      table.year,
      table.month
    ),
...
export const leaseOnerousPostLock = pgTable(
  'lease_onerous_post_lock',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    assessmentId: text('assessment_id')
  ...
  table => ({
    assessmentIdx: index('idx_onerous_post_lock_assessment').on(
      table.assessmentId
    ),
    uniqueAssessmentPeriod: unique('onerous_post_lock_unique').on(
      table.assessmentId,
      table.year,
      table.month
    ),
...
export const leaseExit = pgTable(
  'lease_exit',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    leaseId: text('lease_id')
      .notNull()
      .references(() => lease.id, { onDelete: 'cascade' }),
    componentId: text('component_id').references(() => leaseComponent.id, {
      onDelete: 'cascade',
    }),
  ...
  table => ({
    companyDateIdx: index('idx_lease_exit_company_date').on(
      table.companyId,
      table.eventDate
    ),
...
export const leaseExitCalc = pgTable(
  'lease_exit_calc',
  {
    id: text('id').primaryKey(),
    exitId: text('exit_id')
      .notNull()
      .references(() => leaseExit.id, { onDelete: 'cascade' }),
...
export const leaseExitFx = pgTable(
  'lease_exit_fx',
  {
    id: text('id').primaryKey(),
    exitId: text('exit_id')
...
export const leaseExitPostLock = pgTable(
  'lease_exit_post_lock',
  {
    id: text('id').primaryKey(),
    companyId: text('company_id').notNull(),
    leaseId: text('lease_id').references(() => lease.id, {
      onDelete: 'cascade',
    }),
    componentId: text('component_id').references(() => leaseComponent.id, {
      onDelete: 'cascade',
  ...
  table => ({
    companyDateIdx: index('idx_lease_exit_post_lock_company_date').on(
      table.companyId,
      table.eventDate
    ),
    leaseIdx: index('idx_lease_exit_post_lock_lease').on(table.leaseId),
    componentIdx: index('idx_lease_exit_post_lock_component').on(
      table.componentId
    ),
    statusIdx: index('idx_lease_exit_post_lock_status').on(table.status),
    uniqueCompanyLeaseComponentDate: unique('lease_exit_post_lock_unique').on(
      table.companyId,
      table.leaseId,
      table.componentId,
      table.eventDate
...
export const leaseRestoration = pgTable(
  'lease_restoration',
  {
    id: text('id').primaryKey(),
    leaseId: text('lease_id')
...
export const leaseBuyoutFaLink = pgTable(
  'lease_buyout_fa_link',
  {
    id: text('id').primaryKey(),
    exitId: text('exit_id')
      .notNull()
  ...
  table => ({
    ...
    uniqueExitFa: unique('lease_buyout_fa_link_unique').on(
      table.exitId,
      table.faAssetId
    ),
  })
...
export const leaseExitEvidence = pgTable(
  'lease_exit_evidence',
  {
    id: text('id').primaryKey(),
    exitId: text('exit_id')
  ...
  table => ({
    ...
    uniqueExitEvidence: unique('lease_exit_evidence_unique').on(
      table.exitId,
      table.evidenceId
    ),
  })
