...
export const dimCostCenterRelations = relations(
  dimCostCenter,
  ({ one, many }) => ({
...
export const glDimensionRoutesRelations = relations(
  glDimensionRoutes,
  ({ one }) => ({
    dimCostCenter: one(dimCostCenter, {
...
export const taxReturnDetailRelations = relations(
  taxReturnDetail,
  ({ one }) => ({
    taxReturnRun: one(taxReturnRun, {
...
export const taxReturnExportRelations = relations(
  taxReturnExport,
  ({ one }) => ({
    taxReturnRun: one(taxReturnRun, {
...
export const icMatchProposalLineRelations = relations(
  icMatchProposalLine,
  ({ one }) => ({
...
export const icMatchProposalRelations = relations(
  icMatchProposal,
  ({ many }) => ({
...
export const icWorkbenchDecisionRelations = relations(
  icWorkbenchDecision,
  ({ one }) => ({
    icMatchProposal: one(icMatchProposal, {
...
export const sanctionScreenRunRelations = relations(
  sanctionScreenRun,
  ({ many }) => ({
...
export const budgetVersionRelations = relations(
  budgetVersion,
  ({ one, many }) => ({
...
export const budgetAlertRuleRelations = relations(
  budgetAlertRule,
  ({ one }) => ({
    company: one(company, {
...
export const cashForecastVersionRelations = relations(
  cashForecastVersion,
  ({ one, many }) => ({
    company: one(company, {
...
export const driverProfileRelations = relations(
  driverProfile,
  ({ one, many }) => ({
    company: one(company, {
...
export const forecastVersionRelations = relations(
  forecastVersion,
  ({ one, many }) => ({
    forecastLines: many(forecastLine),
    company: one(company, {
...
export const cashAlertIdempotencyRelations = relations(
  cashAlertIdempotency,
  ({ one }) => ({
    company: one(company, {
...
export const allocRuleTargetRelations = relations(
  allocRuleTarget,
  ({ one }) => ({
