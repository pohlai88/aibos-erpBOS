...
export type ConsolRateOverrideUpsertType = z.infer<
  typeof ConsolRateOverrideUpsert
>;
...
export type ConsolLedgerOptionUpsertType = z.infer<
  typeof ConsolLedgerOptionUpsert
>;
...
export type ConsolRatePolicyResponseType = z.infer<
  typeof ConsolRatePolicyResponse
>;
export type ConsolRateOverrideResponseType = z.infer<
  typeof ConsolRateOverrideResponse
>;
export type ConsolCtaPolicyResponseType = z.infer<
  typeof ConsolCtaPolicyResponse
>;
export type ConsolNciMapResponseType = z.infer<typeof ConsolNciMapResponse>;
export type ConsolLedgerOptionResponseType = z.infer<
  typeof ConsolLedgerOptionResponse
>;

// --- IC Auto-Matching Response Type Exports (M21.2) --------------------------
export type IcElimRuleResponseType = z.infer<typeof IcElimRuleResponse>;
export type IcMatchProposalResponseType = z.infer<
  typeof IcMatchProposalResponse
>;
export type IcWorkbenchDecisionResponseType = z.infer<
  typeof IcWorkbenchDecisionResponse
>;
