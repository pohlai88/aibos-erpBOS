...
export const EvidenceAttestationQuery = z.object({
  ...
  attestation_type: z
    .enum(['REVIEW', 'APPROVAL', 'VERIFICATION', 'CERTIFICATION'])
    .optional(),
...
export type EvidenceAttestationQueryType = z.infer<
  typeof EvidenceAttestationQuery
>;

export type EvidenceManifestResponseType = z.infer<
  typeof EvidenceManifestResponse
>;
...
export type EvidenceAttestationResponseType = z.infer<
  typeof EvidenceAttestationResponse
>;
