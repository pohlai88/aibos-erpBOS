...
export const RevProdPolicyUpsert = z.object({
    product_id: z.string(),
    method: z.enum(['POINT_IN_TIME', 'RATABLE_DAILY', 'RATABLE_MONTHLY', 'USAGE']),
...
export const POBQuery = z.object({
    ...
    method: z.enum(['POINT_IN_TIME', 'RATABLE_DAILY', 'RATABLE_MONTHLY', 'USAGE']).optional(),
...
export const EventCreate = z.object({
    pob_id: z.string(),
    kind: z.enum(['ACTIVATE', 'FULFILL', 'PAUSE', 'RESUME', 'CANCEL', 'REFUND', 'USAGE_REPORT']),
...
export const EventQuery = z.object({
    pob_id: z.string().optional(),
    kind: z.enum(['ACTIVATE', 'FULFILL', 'PAUSE', 'RESUME', 'CANCEL', 'REFUND', 'USAGE_REPORT']).optional(),
...
export type RecognitionLineResponseType = z.infer<typeof RecognitionLineResponse>;
