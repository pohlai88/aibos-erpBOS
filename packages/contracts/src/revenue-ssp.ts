...
export const SspPolicyUpsert = z.object({
  ...
  default_method: z
    ...
    .default('OBSERVABLE'),
  corridor_tolerance_pct: z.number().min(0).max(1).default(0.2),
...
export type AllocateFromInvoiceRespType = z.infer<
  typeof AllocateFromInvoiceResp
>;
export type AllocationAuditQueryType = z.infer<typeof AllocationAuditQuery>;
export type ProspectiveReallocationReqType = z.infer<
  typeof ProspectiveReallocationReq
>;
export type ProspectiveReallocationRespType = z.infer<
  typeof ProspectiveReallocationResp
>;
...
export type AllocationAuditResponseType = z.infer<
  typeof AllocationAuditResponse
>;
