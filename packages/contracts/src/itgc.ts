...
export const ItConnectorSchema = z.enum([
  'SCIM',
  'SAML',
  'OIDC',
  'SQL',
...
export const ItUserStatusSchema = z.enum([
  'ACTIVE',
  'DISABLED',
  'LOCKED',
  'TERMINATED',
]);
export const ItEntitlementKindSchema = z.enum([
  'ROLE',
  'GROUP',
  'PRIV',
  'SCHEMA',
...
export const ItGrantSourceSchema = z.enum([
  'HR',
  'JOINER',
  'TICKET',
  'EMERGENCY',
...
export const ItSodSeveritySchema = z.enum([
  'LOW',
  'MEDIUM',
  'HIGH',
  'CRITICAL',
]);
export const ItSodViolationStatusSchema = z.enum([
  'OPEN',
  'WAIVED',
  'RESOLVED',
]);
export const UarCampaignStatusSchema = z.enum([
  'DRAFT',
  'OPEN',
  'ESCALATED',
  'CLOSED',
]);
export const UarItemStateSchema = z.enum([
  'PENDING',
  'CERTIFIED',
  'REVOKE',
  'EXCEPTION',
]);
export const ItSnapshotScopeSchema = z.enum([
  'USERS',
  'ROLES',
  'GRANTS',
  'SOD',
