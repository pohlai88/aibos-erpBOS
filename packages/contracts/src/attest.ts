...
export const AttestCampaignStateSchema = z.enum(["DRAFT", "ISSUED", "CLOSED", "ARCHIVED"]);
export const AttestTaskStateSchema = z.enum(["OPEN", "IN_PROGRESS", "SUBMITTED", "RETURNED", "APPROVED", "REVOKED"]);
export const AttestSlaStateSchema = z.enum(["OK", "DUE_SOON", "LATE", "ESCALATED"]);

// Question Types
export const QuestionTypeSchema = z.enum(["YN", "TEXT", "MULTI_SELECT", "EVIDENCE", "ATTACHMENT"]);
...
export type AttestTemplateStatusType = z.infer<typeof AttestTemplateStatusSchema>;
...
export type AttestAssignmentResponseType = z.infer<typeof AssignmentResponseSchema>;
...
export type CampaignSummaryResponseType = z.infer<typeof CampaignSummaryResponseSchema>;

export type AttestHeatMapRowType = z.infer<typeof AttestHeatMapRowSchema>;
export type AttestHeatMapResponseType = z.infer<typeof AttestHeatMapResponseSchema>;
