...
export const LeaseIndexPlanResponse = z.object({
    lease_id: z.string(),
    planned_resets: z.array(z.object({
        index_code: z.string(),
...
export const LeaseModCreateReq = z.object({
    ...
    lines: z.array(z.object({
        ...
        action: z.enum(['INCREASE', 'DECREASE', 'RENT_FREE', 'DEFERRAL', 'EXTEND', 'SHORTEN', 'RATE_RESET', 'AREA_CHANGE']),
...
export const LeaseModApplyResponse = z.object({
    ...
    pre_carrying: z.object({
        ...
        total_rou: z.number(),
        component_carryings: z.array(z.object({
            component_id: z.string(),
            component_code: z.string(),
            carrying_amount: z.number()
        }))
    ...
    deltas: z.object({
        ...
        rou_delta: z.number(),
        component_deltas: z.array(z.object({
            component_id: z.string(),
            component_code: z.string(),
            liability_delta: z.number(),
            rou_delta: z.number()
    ...
    schedule_deltas: z.array(z.object({
        component_id: z.string(),
        year: z.number(),
        month: z.number(),
        liab_delta: z.number(),
...
// Type Exports
export type LeaseIndexValueImportReqType = z.infer<typeof LeaseIndexValueImportReq>;
...
export type LeaseRemeasureDisclosureReqType = z.infer<typeof LeaseRemeasureDisclosureReq>;
export type LeaseRemeasureDisclosureResponseType = z.infer<typeof LeaseRemeasureDisclosureResponse>;
...
export const ImpairmentIndicatorUpsert = z.object({
    ...
    kind: z.enum(['BUDGET_SHORTFALL', 'VACANCY', 'MARKET_RENT_DROP', 'SUBLEASE_LOSS', 'OTHER']),
...
export const ImpairmentIndicatorQuery = z.object({
    ...
    lease_component_id: z.string().optional(),
    kind: z.enum(['BUDGET_SHORTFALL', 'VACANCY', 'MARKET_RENT_DROP', 'SUBLEASE_LOSS', 'OTHER']).optional(),
...
export const SubleaseCreateReq = z.object({
    ...
    componentLinks: z.array(z.object({
...
export const LeaseExitEvidenceReq = z.object({
    ...
    evidence_type: z.enum(['TERMINATION_LETTER', 'SETTLEMENT_INVOICE', 'MAKE_GOOD_REPORT', 'BUYOUT_AGREEMENT', 'RESTORATION_QUOTE', 'OTHER']),
    description: z.string().optional()
});
...
export type LeaseRestorationPostReqType = z.infer<typeof LeaseRestorationPostReq>;
export type LeaseRestorationPostResponseType = z.infer<typeof LeaseRestorationPostResponse>;
export type LeaseExitDisclosureReqType = z.infer<typeof LeaseExitDisclosureReq>;
export type LeaseExitDisclosureResponseType = z.infer<typeof LeaseExitDisclosureResponse>;
...
export type ImpairmentIndicatorUpsertType = z.infer<typeof ImpairmentIndicatorUpsert>;
export type ImpairmentIndicatorQueryType = z.infer<typeof ImpairmentIndicatorQuery>;
...
export type OnerousAssessmentUpsertType = z.infer<typeof OnerousAssessmentUpsert>;
...
export type ImpairmentOnerousDisclosureReqType = z.infer<typeof ImpairmentOnerousDisclosureReq>;
export type ImpairmentOnerousDisclosureResponseType = z.infer<typeof ImpairmentOnerousDisclosureResponse>;
...
export type SubleaseScheduleRebuildReqType = z.infer<typeof SubleaseScheduleRebuildReq>;
export type SubleaseScheduleRebuildResponseType = z.infer<typeof SubleaseScheduleRebuildResponse>;
export type SubleaseScheduleQueryType = z.infer<typeof SubleaseScheduleQuery>;
export type SubleaseScheduleResponseType = z.infer<typeof SubleaseScheduleResponse>;
export type SubleasePostingReqType = z.infer<typeof SubleasePostingReq>;
export type SubleasePostingResponseType = z.infer<typeof SubleasePostingResponse>;
export type HeadLeaseAdjustmentReqType = z.infer<typeof HeadLeaseAdjustmentReq>;
export type HeadLeaseAdjustmentResponseType = z.infer<typeof HeadLeaseAdjustmentResponse>;
