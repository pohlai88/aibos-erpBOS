...
export const PostCheckTypeSchema = z.enum(["bvaImproves", "breachesZero", "errCountBelow"]);
...
export type PlaybookVersionResponseM27_2 = z.infer<typeof PlaybookVersionResponseM27_2>;
